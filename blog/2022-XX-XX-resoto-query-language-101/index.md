...
And so, we developed our own query language tailored specifically to Resoto. The [Resoto shell (`resh`)](/docs/concepts/components/resh) allows you to interact with your Resoto installation. In particular, it provides a [`query`](/docs/reference/cli/query) command.
