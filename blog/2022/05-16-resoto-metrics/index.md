...
If you already know what graph and time series databases, metrics, Prometheus and Grafana are you can [skip ahead to the next chapter](#getting-started). For anyone not deep into the cloud native ecosystem let's get some concepts and terminology out of the way.
