...
date: 2022-03-03
authors: [matthias]
tags: [Resoto CLI, Search, Unified Data Model]
description: Resoto's search allows for resources to be selected using filters, combinators, and traversals. Search results can be combined, grouped, and aggregated.
---
...
This blog post is the second in a series about Resoto's powerful search functionality. [Resoto Search 101](../resoto-search-101/index.mdx) provides an introduction to Resoto's search capabilities.
