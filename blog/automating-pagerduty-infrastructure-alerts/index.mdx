...
date: 2023-03-07
authors: [matthias]
tags: [Automation, Security, Resoto CLI, PagerDuty]
description: Resoto ensures that information about your cloud resources is always available by routinely collecting infrastructure data across cloud providers, accounts, regions, and a plethora of services. However, simply having cloud resource data is not enough; it is also crucial to automate actions based on this data.
---
