...
description: Performing security benchmarks on your cloud resources is an important step in ensuring the security and compliance of your organization's cloud environment. Resoto Sentinel simplifies the benchmarking process.
---
...
- **[<abbr title="Health Insurance Portability and Accountability Act">HIPAA</abbr> Security Rule](https://hhs.gov/hipaa/for-professionals/security/index.html)** provides a set of requirements for protecting patients' electronically stored, protected health information (ePHI).
...
However, [Resoto Sentinel](/sentinel) enables you to perform crucial audits multiple times per _day_, dramatically reducing the window of opportunity for security breaches to occur.
