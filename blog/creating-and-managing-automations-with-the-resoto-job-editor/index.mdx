...
description: The Resoto job editor provides a low-code way to create and manage automated jobs.
---

# Creating and Managing Automations with the Resoto Job Editor

Welcome to my first blog post! I'm Raffa and I'm excited to share a new feature that I've been working on: the job editor in [Resoto UI](/docs/getting-started/launch-resoto#resoto-ui).
...
The typical job consists of three parts: a [trigger](./index.mdx#job-triggers), a [filter](./index.mdx#job-filters), and an [action](./index.mdx#job-actions). The filter and action combine to form the command that executes in response to the trigger.
