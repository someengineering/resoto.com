...
To get started, add your DigitalOcean API tokens to [Resoto Worker](/docs/reference/components/worker) via the [`config` command](/docs/reference/cli/config) in [Resoto Shell](/docs/reference/components/shell):

```bash
> config edit resoto.worker
```

In the text editor opened by [`config edit`](/docs/reference/cli/config/edit), modify the configuration as follows:
