...
date: 2022-04-19
authors: [nikita]
tags: [DigitalOcean, Unified Data Model, Resoto CLI, Search, Data Visualization, Resource Tagging, Resource Cleanup]
description: Resoto now supports DigitalOcean!
---
...
To get started, add your DigitalOcean API tokens to [Resoto Worker](/docs/reference/components/worker) via the [`config` command](/docs/reference/cli/setup-commands/config) in [Resoto Shell](/docs/reference/components/shell):

```bash
> config edit resoto.worker
```

In the text editor opened by [`config edit`](/docs/reference/cli/setup-commands/config/edit), modify the configuration as follows:
