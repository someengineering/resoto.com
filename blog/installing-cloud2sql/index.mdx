...
date: 2023-01-17
authors: [lukas]
tags: [Cloud2SQL, Data Export, SQL, AWS, Google Cloud, DigitalOcean]
description: Cloud2SQL is a tool based on Resoto's collector plugins that allows you to collect data from various cloud infrastructure sources and export it to a database.
---
...
<AsciinemaPlayer src={require('./asciinema/cloud2sql-install.cast').default} cols={80} rows={20} preload={true} autoPlay={false} loop={false} poster="npt:0:6" />
...
<AsciinemaPlayer src={require('./asciinema/cloud2sql-cfg_and_run.cast').default} cols={80} rows={20} preload={true} autoPlay={false} loop={false} poster="npt:0:3" />
