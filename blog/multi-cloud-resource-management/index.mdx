...
date: 2022-09-22
authors: [matthias]
tags: [Cloud Asset Inventory, Search, Unified Data Model, Resoto CLI, AWS]
description: Resoto collects data from different services and different cloud providers. Resoto not only makes the data for all cloud provider services available, but also abstracts and unifies this data.
---
...
- [AWS Resource Data Models](/docs/reference/unified-data-model/aws)
- [Google Cloud Resource Data Models](/docs/reference/unified-data-model/google-cloud)
