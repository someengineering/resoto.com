...
**We merged a total of 75 pull requests in June and released [Resoto 3.6.0](/releases/3.6.0)!** This release brought with it a brand-new feature, Resoto DataLink, along with several bug fixes and enhancements.
...
**Resoto DataLink enables you to pipe any Resoto search into the new `db` command and sync the results to a database.** As of now, we support PostgreSQL, MySQL/MariaDB, and SQLite.
...
We're in the process of developing a new module. This addition will enrich your inventory data with usage statistics. Instead of merely seeing how many resources of which kind you have, you'll also be able to see how they're utilized.
