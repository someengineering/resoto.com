...
Finding and installing an Infrastructure App is a breeze with the [`apps` command](/docs/reference/cli/miscellaneous-commands/apps), which allows you to search for and install apps.
