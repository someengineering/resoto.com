...
**[Resoto Rewind](/rewind) is a new module in [Resoto 3.5](/releases/3.5.0) that takes snapshots of the Resoto [asset inventory graph](/docs/concepts/asset-inventory-graph) creates a timeline of changes in your cloud infrastructure.**
