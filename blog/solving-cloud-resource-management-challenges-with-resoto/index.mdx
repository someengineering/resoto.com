...
date: 2022-10-14
authors: [anja]
tags: [cloud asset inventory, data model, resource tagging, resoto cli, aws]
---
...
Generally speaking, the API for every service covers the typical resource lifecycle: creation, tagging, description, and deletion. However, this is where the similarities end. In Resoto, [everything is a resource](../multi-cloud-resource-management-with-resoto/index.mdx).
