...
date: 2023-03-31
authors: [lars]
tags: [Infrastructure Fragmentation, Cloud Asset Inventory, Resoto CLI, Search, Resource Cleanup, Unified Data Model, Graph Database]
---
...
- the [`clean` command](/docs/reference/cli/action-commands/clean) to mark those `volume`s for [cleanup](/docs/concepts/resource-management/cleanup).
