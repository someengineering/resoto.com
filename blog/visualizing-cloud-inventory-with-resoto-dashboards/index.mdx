...
date: 2023-02-06
authors: [pablo]
tags: [cloud asset inventory, ui, dashboard, visualization]
---
...
This widget gets data from a Prometheus time-series database. Check out [Building Actionable Cloud Infrastructure Metrics](../building-actionable-cloud-infrastructure-metrics/index.mdx#how-metrics-are-made) for details on how to add and configure metrics.
