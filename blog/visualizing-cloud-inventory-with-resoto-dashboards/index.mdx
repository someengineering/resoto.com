...
description: Resoto Dashboards are a new way to visualize and share your cloud inventory data.
---
...
Once Resoto is up and running, you can access the web UI by following [these instructions](/docs/getting-started/launch-resoto#resoto-ui).
