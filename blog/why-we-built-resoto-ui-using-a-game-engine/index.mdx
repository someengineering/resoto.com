...
authors: [raffa]
tags: [Resoto UI]
description: Resoto was built using Godot Engine to offer an interesting and fun UI that encourages users to explore their cloud in new and exciting ways.
---
...
One of the key challenges we faced was working with a [directed graph](/docs/concepts/asset-inventory-graph), the internal data structure used by Resoto.
...
<YoutubeEmbed id="AVAU2JjvHug" title="Resoto UI Prototype Demo" />
