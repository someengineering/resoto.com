...
| **Resources** | Supports over 200 [AWS](/docs/reference/unified-data-model/aws), 60 [Google Cloud](/docs/reference/unified-data-model/google-cloud), and 50 [DigitalOcean](/docs/reference/unified-data-model/digitalocean) resource types. | Only supports about 20 AWS, 5 Azure, 5 Google Cloud, and 3 DigitalOcean resource types. |
