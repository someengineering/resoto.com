...
To protect a resource, simply perform a search and pipe the result to [`protect`](../../reference/cli/action-commands/protect.mdx).
...
Pipe a resource to [`set_metadata protected=false`](../../reference/cli/action-commands/set_metadata.mdx) to unprotect a resource.
