...
10. If it is your first time starting Resoto UI, the setup wizard will appear to help you configure Resoto:
...
2. If it is your first time starting Resoto UI, the setup wizard will appear to help you configure Resoto:
...
4. If it is your first time starting Resoto UI, the setup wizard will appear to help you configure Resoto:
...
1. A public available service endpoint is provided by default. With configured access to the Kubernetes cluster, you can get the address using this command:
...
2. Copy and paste the printed address to your browser to access Resoto UI.
