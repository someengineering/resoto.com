...
1.  Resoto UI listens on port `8900` by default. You can access it by opening [https://localhost:8900](https://localhost:8900) in your browser.
...
2.  Log in with your Resoto credentials:
    ...
    Additional users can be added via the [CLI](../../reference/cli/index.mdx) using the [`user add` command](../../reference/cli/user/add.mdx).
...
The Resoto AWS <abbr title="Cloud Development Kit">CDK</abbr> construct is no longer actively maintained. We recommend [running Resoto using Docker](../install-resoto/index.mdx).
...
The Resoto DigitalOcean Marketplace app is no longer actively maintained. We recommend [running Resoto using Docker](../install-resoto/index.mdx).
...
The Resoto Helm chart is no longer actively maintained. We recommend [running Resoto using Docker](../install-resoto/index.mdx).
...
Resoto consists of a number of distributed components that are intended to run 24/7 on a server. We recommend [running Resoto using Docker](../install-resoto/index.mdx).
