...
7. If it is your first time accessing Resoto, you will see a form to create an account. This form is visible only to the first user accessing the installation. This user becomes an administrator automatically. Subsequent users can be added by any Resoto administrator. See [Login and Authentication](../../reference/security/index.mdx#login-based-access) for more information.

   ![Screenshot of Resoto UI signup form](img/create-account.png)

8. After the signup, Resoto UI starts up and a setup wizard will appear to help you configure Resoto:
...
3. If it is your first time accessing Resoto, you will see a form to create an account. This form is visible only to the first user accessing the installation. This user becomes an administrator automatically. Subsequent users can be added by any Resoto administrator. See [Login and Authentication](../../reference/security/index.mdx#login-based-access) for more information.

   ![Screenshot of Resoto UI signup form](img/create-account.png)

4. After the signup, Resoto UI starts up and a setup wizard will appear to help you configure Resoto:
...
2. If it is your first time accessing Resoto, you will see a form to create an account. This form is visible only to the first user accessing the installation. This user becomes an administrator automatically. Subsequent users can be added by any Resoto administrator. See [Login and Authentication](../../reference/security/index.mdx#login-based-access) for more information.

   ![Screenshot of Resoto UI signup form](img/create-account.png)

3. After the signup, Resoto UI starts up and a setup wizard will appear to help you configure Resoto:
