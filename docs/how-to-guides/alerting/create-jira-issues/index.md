...
We do not recommend creating a [job](../../../concepts/automation/index.md) using the `jira` command at this time, as this will result in the creation of a new ticket each hour while the search condition remains true.
