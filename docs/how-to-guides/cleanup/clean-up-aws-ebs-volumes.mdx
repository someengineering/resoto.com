...
3. Execute the following search in [Resoto Shell](../../reference/components/shell.mdx) to list all unused EBS volumes:
...
5. Now that we've defined the search for unused EBS volumes, simply pipe the result of the search query to the [`clean` command](../../reference/cli/action-commands/clean.mdx):
