...
The [Amazon Web Services (AWS)](../../reference/unified-data-model/aws.mdx) collector is configured within the [Resoto Worker configuration](../../reference/configuration/index.mdx) via the [`config` command](../../reference/cli/setup-commands/configs) in [Resoto Shell](../../reference/components/shell).
...
1. Open the [Resoto Worker configuration](../../reference/configuration/index.mdx) via the [`config` command](../../reference/cli/setup-commands/configs) in [Resoto Shell](../../reference/components/shell):
...
2. Open the [Resoto Worker configuration](../../reference/configuration/index.mdx) via the [`config` command](../../reference/cli/setup-commands/configs) in [Resoto Shell](../../reference/components/shell):
...
See [How to Roll Out Resoto AWS Permissions with CloudFormation](../configuration/roll-out-resoto-aws-permissions-with-cloudformation/index.mdx) for a step-by-step guide on how to roll out Resoto [permissions](../../reference/permissions/aws.mdx) organization-wide.
...
1. By default, Resoto performs resource collection each hour. To immediately trigger a collect run, use the [`workflow run` command](../../reference/cli/action-commands/workflows/run.mdx) in [Resoto Shell](../../reference/components/shell):
