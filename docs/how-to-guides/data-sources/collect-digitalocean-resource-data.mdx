...
The [DigitalOcean](../../reference/unified-data-model/digitalocean.mdx) collector is configured within the [Resoto Worker configuration](../../reference/configuration/index.mdx) via the [`config` command](../../reference/cli/config/index.mdx) in [Resoto Shell](../../reference/components/shell.mdx).
