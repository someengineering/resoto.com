...
The [Google Cloud](../../reference/unified-data-model/gcp.mdx) collector is configured within the [Resoto Worker configuration](../../reference/configuration/index.mdx) via the [`config` command](../../reference/cli/setup-commands/configs/index.mdx) in [Resoto Shell](../../reference/components/shell.mdx).
