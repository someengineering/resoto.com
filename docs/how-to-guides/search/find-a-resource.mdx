...
1. Execute the [`search` command](../../reference/cli/search-commands/search.mdx) in [Resoto Shell](../../reference/components/shell.mdx) with your search term in double quotes:
...
2. To view resource details, use the [`dump` command](../../reference/cli/format-commands/dump.mdx):
