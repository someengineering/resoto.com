...
1. Execute the [`search` command](../../../reference/cli/search.mdx) in [Resoto Shell](../../../reference/components/shell.mdx) to get the resource for which we want to see the blast radius:
