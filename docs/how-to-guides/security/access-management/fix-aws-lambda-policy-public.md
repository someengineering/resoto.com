---
sidebar_label: Fix AWS Lambda functions have resource-based policy set as Public
---

# How to Fix AWS Lambda functions have resource-based policy set as Public
