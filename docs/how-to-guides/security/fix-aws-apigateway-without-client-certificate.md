---
sidebar_label: Fix AWS API Gateway without Client Certificate
---

# How to Fix AWS API Gateway without Client Certificate enabled to access your Backend Endpoint
