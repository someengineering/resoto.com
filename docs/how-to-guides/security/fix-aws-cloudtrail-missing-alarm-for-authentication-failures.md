---
sidebar_label: Fix AWS CloudTrail missing Alarm for Authentication Failures
---

# How to Fix AWS CloudTrail missing Alarm for AWS Management Console authentication failures
