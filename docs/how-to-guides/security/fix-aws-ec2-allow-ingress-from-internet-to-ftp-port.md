---
sidebar_label: Fix AWS EC2 Security Group allows ingress from Everywhere to FTP ports
---

# How to Fix AWS EC2 Security Group allows ingress from Everywhere to FTP ports 20 or 21
