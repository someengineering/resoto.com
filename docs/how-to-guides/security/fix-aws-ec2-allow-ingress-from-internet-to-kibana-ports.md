---
sidebar_label: Fix AWS EC2 Security Group allows ingress from Everywhere to Elasticsearch/Kibana ports
---

# How to Fix AWS EC2 Security Group allows ingress from Everywhere to Elasticsearch/Kibana port 5601, 9200, 9300
