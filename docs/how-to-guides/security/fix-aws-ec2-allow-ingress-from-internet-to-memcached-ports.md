---
sidebar_label: Fix AWS EC2 Security Group allows ingress from Everywhere to Memcached ports
---

# How to Fix AWS EC2 Security Group allows ingress from Everywhere to Memcached port 11211
