---
sidebar_label: Fix AWS EC2 Security Group allows ingress from Everywhere to SQLServer ports
---

# How to Fix AWS EC2 Security Group allows ingress from Everywhere to SQLServer ports
