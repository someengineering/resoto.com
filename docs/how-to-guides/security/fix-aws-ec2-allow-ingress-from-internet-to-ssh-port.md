---
sidebar_label: Fix AWS EC2 Security Group allows ingress from Everywhere to SSH port
---

# How to Fix AWS EC2 Security Group allows ingress from Everywhere to SSH port 22
