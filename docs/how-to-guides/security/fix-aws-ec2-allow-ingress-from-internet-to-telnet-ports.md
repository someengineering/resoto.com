---
sidebar_label: Fix AWS EC2 Security Group allows ingress from Everywhere to Telnet ports
---

# How to Fix AWS EC2 Security Group allows ingress from Everywhere to Telnet ports 23
