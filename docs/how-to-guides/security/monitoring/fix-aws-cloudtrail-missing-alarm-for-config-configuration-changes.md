---
sidebar_label: Fix AWS CloudTrail missing Alarm for AWS Config configuration changes
---

# How to Fix AWS CloudTrail missing Alarm for AWS Config configuration changes
