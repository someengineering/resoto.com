---
sidebar_label: Find AWS EC2 Security Group allows ingress from Everywhere to Elasticsearch/Kibana ports
---

# How to Find AWS EC2 Security Group allows ingress from Everywhere to Elasticsearch/Kibana port 5601, 9200, 9300
