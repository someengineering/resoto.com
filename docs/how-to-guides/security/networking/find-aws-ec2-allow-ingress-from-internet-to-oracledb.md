---
sidebar_label: Find AWS EC2 Security Group allows ingress from Everywhere to OracleDB ports
---

# How to Find AWS EC2 Security Group allows ingress from Everywhere to OracleDB ports 1521, 2483
