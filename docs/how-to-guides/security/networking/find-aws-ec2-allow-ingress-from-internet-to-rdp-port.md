---
sidebar_label: Find AWS EC2 Security Group allows ingress from Everywhere to Microsoft RDP port
---

# How to Find AWS EC2 Security Group allows ingress from Everywhere to Microsoft RDP port 3389
