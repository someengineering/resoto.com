---
sidebar_label: Fix AWS EC2 Security Group allows ingress from Everywhere to Kafka ports
---

# How to Fix AWS EC2 Security Group allows ingress from Everywhere to Kafka port 9092
