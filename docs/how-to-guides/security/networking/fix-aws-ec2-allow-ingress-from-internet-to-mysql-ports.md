---
sidebar_label: Fix AWS EC2 Security Group allows ingress from Everywhere to MySQL ports
---

# How to Fix AWS EC2 Security Group allows ingress from Everywhere to MySQL port 3306
