---
sidebar_label: Fix AWS EC2 Security Group allows ingress from Everywhere to OracleDB ports
---

# How to Fix AWS EC2 Security Group allows ingress from Everywhere to OracleDB ports 1521, 2483
