---
sidebar_label: Fix AWS EC2 Security Group allows ingress from Everywhere to MongoDB
---

# How to Fix AWS EC2 Security Group allows ingress from Everywhere to MongoDB ports 27017 and 27018
