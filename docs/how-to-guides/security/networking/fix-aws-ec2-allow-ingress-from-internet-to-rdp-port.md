---
sidebar_label: Fix AWS EC2 Security Group allows ingress from Everywhere to Microsoft RDP port
---

# How to Fix AWS EC2 Security Group allows ingress from Everywhere to Microsoft RDP port 3389
