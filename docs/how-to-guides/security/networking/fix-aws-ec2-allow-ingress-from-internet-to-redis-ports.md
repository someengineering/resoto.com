---
sidebar_label: Fix AWS EC2 Security Group allows ingress from Everywhere to Redis ports
---

# How to Fix AWS EC2 Security Group allows ingress from Everywhere to Redis port 6379
