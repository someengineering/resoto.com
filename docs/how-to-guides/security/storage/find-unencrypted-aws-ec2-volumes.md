...
2. Pipe the `search` command into the [`dump` command](../../../reference/cli/format-commands/dump.md):
   ...
   The command output will list the details of all non-compliant [`aws_ec2_volume` resources](../../../reference/unified-data-model/aws.md#aws_ec2_volume).
...
- [`aws_ec2_volume` Resource Data Model](../../../reference/unified-data-model/aws.md#aws_ec2_volume)
