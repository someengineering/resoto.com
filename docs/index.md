...
- [Amazon Web Services (AWS)](./getting-started/configure-cloud-resource-collection/aws.md)
- [Google Cloud Platform (GCP)](./getting-started/configure-cloud-resource-collection/gcp.md)
- [DigitalOcean](./getting-started/configure-cloud-resource-collection/digitalocean.md)
- [Kubernetes (K8s)](./getting-started/configure-cloud-resource-collection/kubernetes.md)
- [VMware Vsphere](./reference/data-models/vsphere.md)

See [Configure Cloud Resource Collection](./getting-started/configure-cloud-resource-collection/index.md) for more information on how to configure individual providers.
