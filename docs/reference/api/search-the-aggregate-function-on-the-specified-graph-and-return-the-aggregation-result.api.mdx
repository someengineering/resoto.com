...
<h1 className={"openapi__heading"}>Search the aggregate function on the specified graph and return the aggregation result.</h1>

<MethodEndpoint method={"post"} path={"/graph/{graph_id}/search/aggregate"}></MethodEndpoint>
