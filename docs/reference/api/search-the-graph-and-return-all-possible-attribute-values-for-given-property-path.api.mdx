...
<h1 className={"openapi__heading"}>Search the graph and return all possible attribute values for given property path.</h1>

<MethodEndpoint method={"post"} path={"/graph/{graph_id}/property/values"}></MethodEndpoint>
