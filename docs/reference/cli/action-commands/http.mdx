...
The shape and format of the object can be adjusted with commands such as [`list`](../format-commands/list.mdx), [`format`](../format-commands/format.mdx), [`jq`](../miscellaneous-commands/jq.mdx), etc.

:::tip

You can use the [`chunk`](../miscellaneous-commands/chunk.mdx) command to send chunks of objects:
