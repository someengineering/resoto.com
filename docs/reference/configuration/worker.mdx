...
For [Docker](../../getting-started/install-resoto/index.mdx) and [Kubernetes](../../getting-started/install-resoto/kubernetes.mdx) installations, you can mount configuration files within the `resotoworker` container instead of defining them in the configuration.
