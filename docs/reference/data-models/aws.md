...
Please refer to [Configuring Amazon Web Services Resource Collection](../../getting-started/configuration/cloud-providers/aws.md) for details on how to set up Resoto to collect [Amazon Web Services (AWS)](https://aws.amazon.com) resources.
