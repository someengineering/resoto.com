...
Please refer to [Configure Google Cloud Platform Resource Collection](../../../getting-started/configure-resoto/gcp.md) for details on how to set up Resoto to collect [Google Cloud Platform (GCP)](https://cloud.google.com) resources.
...
![Diagram of gcp_autoscaler data model](./img/gcp_autoscaler.svg)
