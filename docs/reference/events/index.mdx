...
When [jobs](../cli/action-commands/job/index.mdx) or [workflows](../cli/action-commands/workflow/index.mdx) are executed, they run as tasks inside Resoto. A task can produce the following events:
