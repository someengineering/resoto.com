...
class aws_ssm_instance_information {
}
class aws_vpc {
}
aws_alb_target_group -[#1A83AF]-> aws_ec2_instance
...
aws_region -[#1A83AF]-> aws_vpc
aws_ssm_instance_information -[#1A83AF]-> aws_ec2_instance
aws_vpc -[#1A83AF]-> aws_alb_target_group
aws_vpc -[#1A83AF]-> aws_ec2_instance
...
```kroki imgType="plantuml" imgAlt="Diagram of aws_secrets_manager_secret data model"
@startuml
hide empty members
skinparam ArrowColor #ffaf37
skinparam ArrowFontColor #ffaf37
...
class aws_secrets_manager_rotation_rules_type {
**automatically_after_days**: int64
**duration**: string
**schedule_expression**: string
}
class aws_secrets_manager_secret {
**arn**: string
...
**rotation_rules**: aws_secrets_manager_rotation_rules_type
...
resource <|--- aws_resource
aws_resource <|--- aws_secrets_manager_secret
aws_secrets_manager_secret --> aws_secrets_manager_rotation_rules_type
@enduml
```
...
```kroki imgType="plantuml" imgAlt="Diagram of aws_secrets_manager_secret resource relationships"
@startuml
hide empty members
skinparam ArrowColor #ffaf37
skinparam ArrowFontColor #ffaf37
...
## `aws_ssm_instance_information`

<ZoomPanPinch>

```kroki imgType="plantuml" imgAlt="Diagram of aws_ssm_instance_information data model"
@startuml
hide empty members
skinparam ArrowColor #ffaf37
skinparam ArrowFontColor #ffaf37
...
resource <|--- aws_resource
aws_resource <|--- aws_ssm_instance_information
aws_ssm_instance_information --> aws_ssm_instance_aggregated_association_overview
@enduml
```
...
```kroki imgType="plantuml" imgAlt="Diagram of aws_ssm_instance_information resource relationships"
@startuml
hide empty members
skinparam ArrowColor #ffaf37
skinparam ArrowFontColor #ffaf37
