...
There are currently 2 deployment options for Resoto, using [docker compose](/docs/getting-started/installing-with-docker) or [kubernetes](/docs/getting-started/installing-with-kubernetes). The related docker images are listed here:
