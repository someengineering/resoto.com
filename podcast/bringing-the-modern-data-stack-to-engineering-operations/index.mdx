...
description: Faros AI connects the dots between engineering data sources—ticketing, source control, CI/CD, and more—providing visibility and insight into a company's engineering processes.
---
...
<YoutubeEmbed id="O-7gcOFcgH8" title={metadata.title} date={metadata.date} description={metadata.description} />
