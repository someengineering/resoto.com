...
tags: [Open-Source Software, Analytics]
image: ./img/banner-social.jpg
description: MergeStat provides data integration for your Git repositories, facilitating the exploration of legacy code and identification of code that hadn't been touched in a while and maybe deserved new attention.
---

# Creating Operational Analytics with SQL and Git Repositories
...
<YoutubeEmbed id="fBNP8iVSnw0" title={metadata.title} date={metadata.date} description={metadata.description} />
