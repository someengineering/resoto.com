...
description: dbt helps write and execute data transformation jobs by compiling code to SQL and running it against your cloud warehouse.
---

# Data Integration with dbt
...
<YoutubeEmbed id="9piI07cqT_o" title={metadata.title} date={metadata.date} description={metadata.description} />
