...
tags: [Cloud Infrastructure, Site Reliability Engineering, DevOps, Metrics]
image: ./img/banner-social.jpg
description: The shift to cloud-native and more dynamic infrastructure is followed by a change in how developers, architects, and SREs work together. With the sheer quantity of resources running in cloud-native infrastructure and the monitoring signals produced by each resource, the only way to keep growing without "throwing people at the problem" is to turn to automation.
---
...
<YoutubeEmbed id="2zVYIurCJ-A" title={metadata.title} date={metadata.date} description={metadata.description} />
