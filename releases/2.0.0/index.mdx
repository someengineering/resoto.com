...
There are currently two installation options for Resoto: [Docker](/docs/getting-started/install-resoto) and [Kubernetes](/docs/getting-started/install-resoto/kubernetes).
