...
If you are running Resoto locally via [Docker](/docs/getting-started/install-resoto), the UI is accessible via [https://localhost:8900/ui](https://localhost:8900/ui):
