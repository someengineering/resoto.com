...
Developers and SREs can search the graph with a [search syntax](/docs/reference/cli/search-commands/search), and create alerting and cleanup [workflows](/docs/concepts/automation/workflow).
