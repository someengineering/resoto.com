...
**Resoto helps clients manage their cloud services.**
...
Developers and SREs can search the graph with a [search syntax](/docs/reference/search), and create alerting and cleanup [workflows](/docs/reference/workflows).
...
By now, Resoto covers the major global ([AWS](https://aws.amazon.com), [Google Cloud](https://cloud.google.com), [Azure](https://azure.microsoft.com), [Alibaba](https://alibabacloud.com)), specialized ([DigitalOcean](https://digitalocean.com), [Oracle](https://oracle.com), [IBM](https://cloud.ibm.com), etc.), and private/hybrid clouds such as [VMWare](https://cloud.vmware.com) and [Red Hat](https://cloud.redhat.com).
