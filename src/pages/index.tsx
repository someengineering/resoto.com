          ...
          <div className={styles.heroInner}>
            <div className={styles.heroText}>
              ...
              <p>
                ...
                <strong>visibility</strong>, and{' '}
                <strong>react to changes</strong> in your infrastructure.
              </p>
          ...
          <section className={clsx(styles.section, styles.cloudSection)}>
            <div className={styles.sectionInner}>
              <h2 className="text--center">
                Resoto is a meta layer on top of your infrastructure, with
                support for&hellip;
              </h2>
            ...
            <div className={styles.sectionInner}>
              ...
              <ul className={styles.cards}>
                <li>
                  ...
                  <p>
                    Write ad-hoc queries with full-text metadata search across
                    all your cloud accounts using the{' '}
                ...
                <li>
                  ...
                  <p>
                    ...
                    into regular reports with fleet-wide, actionable metrics
                    that you can export to popular tools and share with
                    colleagues in Product or Finance.
                  </p>
                </li>
                <li>
              ...
              <ul className={styles.cards}>
                ...
                <li>
                  ...
                  <p>
                    ...
                    resources when they are deployed, so there are no surprises
                    in your cloud bill.
                  </p>
                </li>
                <li>
                  ...
                  <p>
                    Resoto provides a &ldquo;God View&rdquo; of asset changes
                    and policy violations across all of your clouds, projects,
                    and accounts.
                  </p>
                </li>
              </ul>
              ...
              <ul className={styles.cards}>
                <li>
                  ...
                  <p>
                    ...
                    , or{' '}
                    <Link to="/docs/getting-started/install-resoto/pip">
                      pip
                    </Link>
                    !
                  </p>
                ...
                <li>
                  ...
                  <p>
                    Set up a recurring{' '}
                    <Link to="/docs/concepts/automation#jobs">job</Link> and
                    allow Resoto to take care of resource{' '}
                    <Link to="/docs/concepts/resource-management/cleanup">
                      cleanup
                    </Link>{' '}
                    going forward.
          ...
          <section className={styles.section}>
            <div className={styles.sectionInner}>
              ...
              <p>
                ...
                news, features, events, and articles.
              </p>
