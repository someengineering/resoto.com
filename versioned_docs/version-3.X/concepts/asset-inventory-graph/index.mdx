...
The list of possible edges are also defined explicitly in [Unified Data Model](../../reference/unified-data-model/index.mdx). Alternatively, use the [`kinds` command](../../reference/cli/search-commands/kinds.mdx) to get the same information on the command line.
