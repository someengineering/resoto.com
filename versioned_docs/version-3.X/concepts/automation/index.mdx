...
Jobs are persisted in the Resoto database. The [`job` command](../../reference/cli/action-commands/job/index.mdx) allows you to [add](../../reference/cli/action-commands/job/add.mdx), [update](../../reference/cli/action-commands/job/update.mdx), [delete](../../reference/cli/action-commands/job/delete.mdx), and [list](../../reference/cli/action-commands/job/list.mdx) jobs.
...
- [`job` Command](../../reference/cli/action-commands/job/index.mdx)
