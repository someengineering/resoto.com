...
To tag resources, simply pipe the result of a [search](../../reference/search/index.mdx) into the [`tag` command](../../reference/cli/action-commands/tag/index.mdx).
...
When a resource is tagged on the [Resoto Shell](../../reference/components/shell.mdx), [Resoto Core](../../reference/components/core.mdx) creates a tagging task that is dispatched to a [Worker](../../reference/components/worker.mdx).
