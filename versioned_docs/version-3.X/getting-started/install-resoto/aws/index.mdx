...
<DocCardList items={[
  {type: 'link', href: '/docs/getting-started/install-resoto/aws/cdk', label: 'Cloud Development Kit', docId: 'getting-started/install-resoto/aws/cdk'},
  {type: 'link', href: '/docs/getting-started/install-resoto/aws/web-installer', label: 'Web Installer', docId: 'getting-started/install-resoto/aws/web-installer/index'}
]} />
