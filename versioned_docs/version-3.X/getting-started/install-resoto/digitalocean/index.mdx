...
The DigitalOcean marketplace app is not maintained any longer and will be removed in a future release. We recommend running Resoto via [Docker](../docker.mdx).
