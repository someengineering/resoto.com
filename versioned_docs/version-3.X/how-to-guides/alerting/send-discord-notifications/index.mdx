...
2. Install the `discord` [Infrastructure App](/blog/resoto-infrastructure-apps) using the [`app install` command](../../../reference/cli/miscellaneous-commands/apps/install.mdx):
