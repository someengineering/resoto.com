...
1.  Search for an app using the [`apps search` command](../../reference/cli/miscellaneous-commands/apps/search.mdx):

    ```bash
    > apps search cleanup
    ```

2.  Use the [`apps install` command](../../reference/cli/miscellaneous-commands/apps/install.mdx) to install the app:

    ```bash
    > apps install cleanup-untagged
    ```

3.  Run the app using the [`apps run` command](../../reference/cli/miscellaneous-commands/apps/run.mdx):
    ...
    Please refer to [`apps run` Command](../../reference/cli/miscellaneous-commands/apps/run.mdx) for more information.

    :::

## Further Reading

- [`apps` Command](../../reference/cli/miscellaneous-commands/apps/index.mdx)
