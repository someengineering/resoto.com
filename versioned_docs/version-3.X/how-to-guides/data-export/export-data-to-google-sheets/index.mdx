...
1.  Execute the following [aggregate search](../../../reference/search/aggregation.mdx) in [Resoto Shell](../../../reference/components/shell.mdx):
...
2.  Next, pipe the search result into the [`format `command](../../../reference/cli/format-commands/format.mdx) to flatten it into rows and columns:
...
3.  Then, use the [`write` command](.././../../reference/cli/miscellaneous-commands/write.mdx) to output the data to a CSV file on our local disk:
