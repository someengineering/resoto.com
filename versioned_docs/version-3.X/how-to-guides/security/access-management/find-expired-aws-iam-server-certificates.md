...
2. Pipe the `search` command into the [`dump` command](../../../reference/cli/format-commands/dump.md):
   ...
   The command output will list the details of all non-compliant [`aws_iam_server_certificate` resources](../../../reference/unified-data-model/aws.md#aws_iam_server_certificate).
...
- [`aws_iam_server_certificate` Resource Data Model](../../../reference/unified-data-model/aws.md#aws_iam_server_certificate)
