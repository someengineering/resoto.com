...
2. Pipe the `search` command into the [`dump` command](../../../reference/cli/format-commands/dump.md):
   ...
   The command output will list the details of all non-compliant [`aws_kms_key` resources](../../../reference/unified-data-model/aws.md#aws_kms_key).
...
- [`aws_kms_key` Resource Data Model](../../../reference/unified-data-model/aws.md#aws_kms_key)
