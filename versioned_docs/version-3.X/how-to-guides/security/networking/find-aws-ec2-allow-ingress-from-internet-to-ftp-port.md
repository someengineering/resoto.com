---
sidebar_label: Find AWS EC2 Security Group allows ingress from Everywhere to FTP ports
---

# How to Find AWS EC2 Security Group allows ingress from Everywhere to FTP ports 20 or 21
