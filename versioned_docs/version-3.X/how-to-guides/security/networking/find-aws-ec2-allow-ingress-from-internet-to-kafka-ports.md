---
sidebar_label: Find AWS EC2 Security Group allows ingress from Everywhere to Kafka ports
---

# How to Find AWS EC2 Security Group allows ingress from Everywhere to Kafka port 9092
