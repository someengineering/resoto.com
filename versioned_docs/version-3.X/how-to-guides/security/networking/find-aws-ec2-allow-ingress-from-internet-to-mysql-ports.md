---
sidebar_label: Find AWS EC2 Security Group allows ingress from Everywhere to MySQL ports
---

# How to Find AWS EC2 Security Group allows ingress from Everywhere to MySQL port 3306
