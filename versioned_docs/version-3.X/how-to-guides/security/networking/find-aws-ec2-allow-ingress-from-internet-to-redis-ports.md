---
sidebar_label: Find AWS EC2 Security Group allows ingress from Everywhere to Redis ports
---

# How to Find AWS EC2 Security Group allows ingress from Everywhere to Redis port 6379
