---
sidebar_label: Find AWS EC2 Security Group allows ingress from Everywhere to Telnet ports
---

# How to Find AWS EC2 Security Group allows ingress from Everywhere to Telnet ports 23
