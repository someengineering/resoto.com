module.exports = [
  { type: 'doc', id: 'version-3.X/reference/api/resoto-core-rest-api' },
  {
    type: 'category',
    label: 'graph_search',
    link: { type: 'doc', id: 'version-3.X/reference/api/graph-search' },
    items: [
      {
        type: 'doc',
        id: 'version-3.X/reference/api/search-the-graph-and-return-all-nodes-as-list-this-will-not-contain-any-edges',
        label:
      ...
      {
        type: 'doc',
        id: 'version-3.X/reference/api/search-the-graph-and-return-the-resulting-graph',
        label: 'Search the graph and return the resulting graph.',
        className: 'api-method post',
      },
      {
        type: 'doc',
        id: 'version-3.X/reference/api/search-the-aggregate-function-on-the-specified-graph-and-return-the-aggregation-result',
        label:
      ...
      {
        type: 'doc',
        id: 'version-3.X/reference/api/search-all-history-events-and-return-them',
        label: 'Search all history events and return them.',
        className: 'api-method post',
      },
      {
        type: 'doc',
        id: 'version-3.X/reference/api/search-and-aggregate-history-events-and-return-the-aggregation-result',
        label:
  ...
  },
  {
    ...
    link: { type: 'doc', id: 'version-3.X/reference/api/graph-management' },
    items: [
      {
        type: 'doc',
        id: 'version-3.X/reference/api/list-all-graphs',
        label: 'List all graphs',
        className: 'api-method get',
      },
      {
        type: 'doc',
        id: 'version-3.X/reference/api/get-root-of-a-specific-graph',
        label: 'Get root of a specific graph',
        className: 'api-method get',
      },
      {
        type: 'doc',
        id: 'version-3.X/reference/api/create-a-new-graph',
        label: 'Create a new graph',
        className: 'api-method post',
      },
      {
        type: 'doc',
        id: 'version-3.X/reference/api/delete-an-existing-graph',
        label: 'Delete an existing graph',
        className: 'api-method delete',
      },
      {
        type: 'doc',
        id: 'version-3.X/reference/api/merge-a-given-graph-with-the-existing-graph-under-marked-merge-nodes',
        label:
      ...
      {
        type: 'doc',
        id: 'version-3.X/reference/api/merge-a-given-graph-with-the-existing-graph-under-marked-merge-nodes-as-batch-update',
        label:
      ...
      {
        type: 'doc',
        id: 'version-3.X/reference/api/get-a-list-of-all-running-batch-updates',
        label: 'Get a list of all running batch updates',
        className: 'api-method get',
      },
      {
        type: 'doc',
        id: 'version-3.X/reference/api/commit-a-batch-update',
        label: 'Commit a batch update',
        className: 'api-method post',
      },
      {
        type: 'doc',
        id: 'version-3.X/reference/api/abort-a-batch-update',
  ...
  },
  {
    ...
    link: { type: 'doc', id: 'version-3.X/reference/api/node-management' },
    items: [
      {
        type: 'doc',
        id: 'version-3.X/reference/api/patch-a-list-of-nodes',
        label: 'Patch a list of nodes.',
        className: 'api-method patch',
      },
      {
        type: 'doc',
        id: 'version-3.X/reference/api/create-a-new-node-under-the-given-parent-node',
        label: 'Create a new node under the given parent node',
        className: 'api-method post',
      },
      {
        type: 'doc',
        id: 'version-3.X/reference/api/get-a-node-with-the-given-node-id',
        label: 'Get a node with the given node id',
        className: 'api-method get',
      },
      {
        type: 'doc',
        id: 'version-3.X/reference/api/update-a-node-with-the-given-node-id',
        label: 'Update a node with the given node id',
        className: 'api-method patch',
      },
      {
        type: 'doc',
        id: 'version-3.X/reference/api/delete-a-node-with-the-given-node-id',
        label: 'Delete a node with the given node id.',
        className: 'api-method delete',
      },
      {
        type: 'doc',
        id: 'version-3.X/reference/api/patch-a-node-with-the-given-node-id-in-given-section',
  ...
  },
  {
    type: 'category',
    label: 'model',
    link: { type: 'doc', id: 'version-3.X/reference/api/model' },
    items: [
      {
        type: 'doc',
      ...
      {
        type: 'doc',
        id: 'version-3.X/reference/api/add-or-update-the-current-defined-model',
        label: 'Add or update the current defined model.',
        className: 'api-method patch',
      },
      {
        type: 'doc',
        id: 'version-3.X/reference/api/get-the-currently-defined-model-as-svg-uml-image',
  ...
  },
  {
    type: 'category',
    label: 'config',
    link: { type: 'doc', id: 'version-3.X/reference/api/config' },
    items: [
      {
        type: 'doc',
        id: 'version-3.X/reference/api/get-all-configuration-keys',
        label: 'Get all configuration keys',
        className: 'api-method get',
      },
      {
        type: 'doc',
        id: 'version-3.X/reference/api/get-a-configuration-by-its-id',
        label: 'Get a configuration by its id',
        className: 'api-method get',
      },
      {
        type: 'doc',
        id: 'version-3.X/reference/api/replace-a-configuration-with-given-id',
        label: 'Replace a configuration with given id',
        className: 'api-method put',
      },
      {
        type: 'doc',
        id: 'version-3.X/reference/api/patch-a-configuration-by-its-id',
        label: 'Patch a configuration by its id',
        className: 'api-method patch',
      },
      {
        type: 'doc',
        id: 'version-3.X/reference/api/delete-a-configuration-by-its-id',
  ...
  },
  {
    ...
    link: { type: 'doc', id: 'version-3.X/reference/api/config-validation' },
    items: [
      {
        type: 'doc',
        id: 'version-3.X/reference/api/get-the-currently-defined-configuration-model',
        label: 'Get the currently defined configuration model.',
        className: 'api-method get',
      },
      {
        type: 'doc',
        id: 'version-3.X/reference/api/add-or-update-the-current-defined-configuration-model',
        label: 'Add or update the current defined configuration model.',
        className: 'api-method patch',
      },
      {
        type: 'doc',
        id: 'version-3.X/reference/api/get-all-configuration-keys-that-have-a-model-defined',
        label: 'Get all configuration keys that have a model defined.',
        className: 'api-method get',
      },
      {
        type: 'doc',
        id: 'version-3.X/reference/api/get-a-configuration-validation-by-its-id',
        label: 'Get a configuration validation by its id',
        className: 'api-method get',
      },
      {
        type: 'doc',
        id: 'version-3.X/reference/api/replace-a-configuration-validation-with-given-id',
  ...
  },
  {
    type: 'category',
    label: 'cli',
    link: { type: 'doc', id: 'version-3.X/reference/api/cli' },
    items: [
      {
        type: 'doc',
        id: 'version-3.X/reference/api/evaluate-a-cli-command',
        label: 'Evaluate a cli command',
        className: 'api-method post',
      },
      {
        type: 'doc',
        id: 'version-3.X/reference/api/execute-a-cli-command',
        label: 'Execute a cli command',
        className: 'api-method post',
      },
      {
        type: 'doc',
        id: 'version-3.X/reference/api/get-information-about-cli',
  ...
  },
  {
    type: 'category',
    label: 'subscriptions',
    link: { type: 'doc', id: 'version-3.X/reference/api/subscriptions' },
    items: [
      {
        type: 'doc',
        id: 'version-3.X/reference/api/list-all-subscriptions',
        label: 'List all subscriptions',
        className: 'api-method get',
      },
      {
        type: 'doc',
        id: 'version-3.X/reference/api/list-all-subscribers-for-a-given-event-type',
        label: 'List all subscribers for a given event type',
        className: 'api-method get',
      },
      {
        type: 'doc',
        id: 'version-3.X/reference/api/get-subscriber-by-id',
        label: 'Get subscriber by id',
        className: 'api-method get',
      },
      {
        type: 'doc',
        id: 'version-3.X/reference/api/define-subscriber-with-all-subscriptions',
        label: 'Define subscriber with all subscriptions',
        className: 'api-method put',
      },
      {
        type: 'doc',
        id: 'version-3.X/reference/api/delete-by-id',
        label: 'Delete by id',
        className: 'api-method delete',
      },
      {
        type: 'doc',
        id: 'version-3.X/reference/api/add-subscription-to-subscriber',
        label: 'Add subscription to subscriber',
        className: 'api-method post',
      },
      {
        type: 'doc',
        id: 'version-3.X/reference/api/delete-a-specific-subscription-from-the-subscriber',
        label: 'Delete a specific subscription from the subscriber.',
        className: 'api-method delete',
      },
      {
        type: 'doc',
        id: 'version-3.X/reference/api/web-socket-listen-to-registered-events-of-given-subscriber',
  ...
  },
  {
    type: 'category',
    label: 'work_queue',
    link: { type: 'doc', id: 'version-3.X/reference/api/work-queue' },
    items: [
      {
        type: 'doc',
        id: 'version-3.X/reference/api/web-socket-attach-to-the-working-queue',
        label: '[WebSocket] Attach to the working queue',
        className: 'api-method get',
      },
      {
        type: 'doc',
        id: 'version-3.X/reference/api/list-all-outstanding-work-items',
  ...
  },
  {
    type: 'category',
    label: 'certificate',
    link: { type: 'doc', id: 'version-3.X/reference/api/certificate' },
    items: [
      {
        type: 'doc',
        id: 'version-3.X/reference/api/retrieve-the-certificate-authorities-public-certificate',
        label: 'Retrieve the certificate authorities public certificate.',
        className: 'api-method get',
      },
      {
        type: 'doc',
        id: 'version-3.X/reference/api/sign-a-certificate-request',
  ...
  },
  {
    ...
    items: [
      ...
      {
        type: 'doc',
        id: 'version-3.X/reference/api/list-all-resources-that-match-a-given-check',
  ...
  },
  {
    ...
    items: [
      {
        type: 'doc',
        id: 'version-3.X/reference/api/send-analytics-events-to-the-server',
        label: 'Send analytics events to the server',
        className: 'api-method post',
      },
      {
        type: 'doc',
        id: 'version-3.X/reference/api/web-socket-register-as-event-listener-and-receive-all-events',
        label: '[WebSocket] Register as event listener and receive all events.',
        className: 'api-method get',
      },
      {
        type: 'doc',
        id: 'version-3.X/reference/api/this-endpoint-signals-if-the-system-is-ready-to-serve-traffic',
        label: 'This endpoint signals if the system is ready to serve traffic.',
        className: 'api-method get',
      },
      {
        type: 'doc',
        id: 'version-3.X/reference/api/send-a-ping-to-the-system-and-expect-a-pong',
  ...
  },
  {
    type: 'category',
    label: 'debug',
    link: { type: 'doc', id: 'version-3.X/reference/api/debug' },
    items: [
      {
        type: 'doc',
  ...
  },
  {
    type: 'category',
    label: 'tsdb',
    link: { type: 'doc', id: 'version-3.X/reference/api/tsdb' },
    items: [
      {
        type: 'doc',
