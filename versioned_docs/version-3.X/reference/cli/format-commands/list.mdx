...
The `list` command transforms inputted [<abbr title="JavaScript Object Notation">JSON</abbr>](https://json.org) objects into `string`s.
...
| ------------ | --------------------------- | --------- | ------------- |
| `properties` | Names of properties to show | ❌        |               |
