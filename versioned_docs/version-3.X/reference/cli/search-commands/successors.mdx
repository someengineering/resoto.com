...
The `successors` command selects all [successors](../../../concepts/asset-inventory-graph/index.mdx#successors) of [nodes](../../../concepts/asset-inventory-graph/index.mdx#nodes) returned in a query.
