...
The [`aggregate` command](../../reference/cli/aggregate.mdx) tells Resoto to aggregate the search results based on the defined criteria. Each result of the search is then passed to the defined aggregation function(s).
