...
| ---------------------------------------------------------------------- | ------------------- |
| [`predecessors`](../../reference/cli/search-commands/predecessors.mdx) | `<--` or `<-[1:1]-` |
| [`successors`](../../reference/cli/search-commands/successors.mdx)     | `-->` or `-[1:1]->` |
| [`ancestors`](../../reference/cli/search-commands/ancestors.mdx)       | `<-[1:]-`           |
| [`descendants`](../../reference/cli/search-commands/descendants.mdx)   | `-[1:]->`           |
